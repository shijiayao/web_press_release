...
INSERT INTO user
VALUES (NULL, 1, 'admin', MD5('@_987654321'), '天动万象', 'admin@email.com', '18888888888', '钟离', 1, 1, NOW(), NOW()),
       (NULL, 10, 'admin-01', MD5('@_987654321'), '梦想真说', 'admin-01@email.com', '18800001111', '雷电影', 0, 1, NOW(), NOW()),
       (NULL, 10, 'admin-02', MD5('@_987654321'), '风神之诗', 'admin-02@email.com', '18800002222', '温迪', 1, 1, NOW(), NOW()),
       (NULL, 1000, 'user-01', MD5('@_987654321'), '蹦蹦炸弹', 'user-01@email.com', '18822221111', '可莉', 0, 1, NOW(), NOW()),
       (NULL, 1000, 'user-02', MD5('@_987654321'), '万叶之一刀', 'user-02@email.com', '18822222222', '枫原万叶', 1, 1, NOW(), NOW());
...
(
  ...
  DEFAULT CHARSET = utf8;
INSERT INTO links
VALUES (NULL, '明珠号', 'https://mzmedia.eastday.com', '/static/image/friend-links/202205011601430400017377.png', NOW(), NOW()),
       (NULL, '简书', 'https://www.jianshu.com', '/static/image/friend-links/202205011601501120121281.png', NOW(), NOW()),
       (NULL, '百度搜索', 'https://www.baidu.com', '/static/image/friend-links/202205011601547004626985.png', NOW(), NOW()),
       (NULL, '百度翻译', 'https://fanyi.baidu.com', '/static/image/friend-links/202205011602002970363700.png', NOW(), NOW());
...
(
  ...
  DEFAULT CHARSET = utf8;
INSERT INTO notice
VALUES (NULL, 10, '管理员才能看到的公告消息', '这是一条只有管理员用户才能看到的公告消息，不会被登录的普通用户看到的公告消息。', NOW(), NOW()),
       (NULL, 2000, '所有登录用户都能看到的公告消息', '这是一条所有登录的用户都能看到的公告消息。', NOW(), NOW()),
       (NULL, 2000, '感谢用户使用本系统', '感谢所有注册用户使用本系统。', NOW(), NOW());
...
(
  ...
  DEFAULT CHARSET = utf8;
INSERT INTO news
VALUES (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000001'), '新疆青年直播电商现状调查：带货主播短缺，部分直播基地空置',
        ...
        '/static/image/news-info/202205041925381196540364.jpeg', 1001, NOW(), NOW()),
       (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000001'), '《闯关东》原班人马再携手，彰显英雄气概和爱国情怀',
        ...
        '', 1001, NOW(), NOW()),
       (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000002'), '国乒有多内卷？陈梦晒晨跑照，秀马甲线！球迷：伊藤美诚赢不了她',
        ...
        '/static/image/news-info/202205041944527752249119.jpeg', 1002, NOW(), NOW()),
       (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000003'), '五四特别策划丨一组海报带你感受青年官兵的热血青春',
        ...
        '/static/image/news-info/202205041946383341693994.jpeg', 1003, NOW(), NOW()),
       (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000004'), '《笑话》算命',
        ...
        '', 1004, NOW(), NOW()),
       (NULL, CONCAT(DATE_FORMAT(NOW(), '%Y%m%d%H%i%S'), '0000000005'), '原神2.7版本草系反应上线，刻晴/八重神子加强',
        ...
        '/static/image/news-info/202205041944249099719955.jpeg', 1005, NOW(), NOW());
